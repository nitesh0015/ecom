...
const Terms = () => {
  ...
  return (
    <>
      <Navbar />
      <Announcement />
      <StyledContactForm className="contain">
        <h1>Terms and conditions</h1>
        <p>
          <h4>OVERVIEW</h4>
          <br />
          This website is operated by Artisans Enterprises Pvt. Ltd. Throughout
          the site, the terms “we”, “us” and “our” refer to Artisans Enterprises
          Pvt. Ltd. Artisans Enterprises Pvt. Ltd offers this website, including
         ...
         <br />
          ...
          <br />
          <br />
           <h6>SECTION 9 - CONTACT INFORMATION </h6>
           <br />
           Questions about the Terms of Service
          should be sent to us at helloji@Artisans.com.
        </p>
      </StyledContactForm>
      <Footer />
    </>
